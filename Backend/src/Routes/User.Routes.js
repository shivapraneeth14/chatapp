...
import { changepassword, logout, register,uploadprofiepic,serachuser,getotherprofile
    ,getcurrentuser,Addfriend,Acceptfriend,Declinefriend,getnotifications} from "../Controllers/Usercontroller.js";
...
router.route("/user/:username").post(verifyjwt,getotherprofile)
